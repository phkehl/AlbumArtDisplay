/*!
    ...
    Modified version of https://github.com/phkehl/esp32-leddisplay for Arduino and c++
    ...
    See leddisplay.cpp for details.
...
/*!
    ...
    \returns 0 on success, or on error: 1 (no memory), 2 (other fail)
*/
...
/*!
    ...
    \param[in] frame  RGB data for one frame, or NULL to clear the display
*/
